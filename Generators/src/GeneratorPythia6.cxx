...
GeneratorPythia6::GeneratorPythia6() :
  GeneratorTGenerator("ALICEo2", "ALICEo2 Pythia6 Generator")
{
  /** default constructor **/
...
GeneratorPythia6::GeneratorPythia6(const Char_t* name, const Char_t* title) :
  GeneratorTGenerator(name, title)
{
  /** constructor **/
