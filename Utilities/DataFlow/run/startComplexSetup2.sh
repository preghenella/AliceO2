...
# Data publishers
xterm -geometry 80x25+500+0 -hold -e DataPublisherDevice --id DataPublisherDeviceTPC --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output  &
xterm -geometry 80x25+500+400 -hold -e DataPublisherDevice --id DataPublisherDeviceITS --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output  &


# this is the subtimeframe publisher for TPC
xterm -geometry 80x25+1000+0 -hold -e lldb -- SubframeBuilderDevice --id subframeBuilderTPC --mq-config confComplexSetup2.json --detector TPC &
...
xterm -geometry 80x25+2000+0 -hold -e epnReceiver --id epnReceiver1 --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output --num-flps 2 &

xterm -geometry 80x25+2000+400 -hold -e epnReceiver --id epnReceiver2 --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output --num-flps 2 &

xterm -geometry 80x25+2000+800 -hold -e epnReceiver --id epnReceiver3 --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output --num-flps 2 &

xterm -geometry 80x25+2000+1200 -hold -e epnReceiver --id epnReceiver4 --mq-config confComplexSetup2.json --in-chan-name input --out-chan-name output --num-flps 2 &
